...
const AllData = () => {
  ...
  const workItems = [
    ...
    },
    {
      ...
      bg: "#FCF4FF",
      client: "TomeCrafters Publishing",
    ...
    },
    {
      ...
      bg: "#FCF4FF",
      client: "Herald Tribune Press",
      langages: "Rails",
      link: "https://www.freepik.com/free-photos-vectors/market-logo",
      linkText: "www.freepik.com",
      description:
        "Enhanced a web application for provisioning and bootstrapping cloud resources at a major newspaper organization across various providers using Rails, ensured code quality through consultations and optimal unit testing for continuous integration and delivery",
    },
    {
      id: "12",
      tag: "Logo",
